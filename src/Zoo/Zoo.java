...
public class Zoo {
    ...
    public Wolf addWolf() {
        ...
        return new Wolf(gender, weight, length, age, birth);
    }
    ...
    public Tiger addTiger() {
        ...
        return new Tiger(gender, weight, length, age, birth);
    }
    ...
    public Bear addBear() {
        ...
        return new Bear(gender, weight, length, age, birth);
    }
    ...
    public Whale addWhale() {
        ...
        return new Whale(gender, weight, length, age, birth);
    }
    ...
    public Goldfish addGoldfish() {
        ...
        return new Goldfish(gender, weight, length, age, birth);
    }
    ...
    public Shark addShark() {
        ...
        return new Shark(gender, weight, length, age, birth);
    }
    ...
    public Eagle addEagle() {
        ...
        return new Eagle(gender, weight, length, age, birth);
    }
    ...
    public Pinguin addPinguin() {
        ...
        return new Pinguin(gender, weight, length, age, birth);
    }
}
